...
```bash
git clone https://github.com/lam0819/composer-store
...
- 10 separate projects using the **Composer Plugin** approach (`cstore/cstore` in `require`)
...
1. User adds `cstore/cstore` to their project's `composer.json`
